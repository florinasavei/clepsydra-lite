...
namespace ClepsydraLite.API.Controllers
{
    ...
    public class SupplierProductOfferController : ControllerBase
    {
        ...
        [HttpGet]
        public IActionResult GetProductsFromCategoryForSuppliers(int supplierId, int supplierProductCategoryId)
        {
        ...
        public IActionResult GetProductsFromCategoryForSupplier(int supplierId, int supplierProductCategoryId, int productId)
        {
        ...
        [HttpPost]
        public IActionResult CreateProductInCategoryForSupplier(int supplierId, int supplierProductCategoryId, [FromBody] SupplierProductOfferForCreationDto supplierProductCategory)
        {
